...
func TestMain(m *testing.M) {
	initCoverage(loggerWithConfigCoverage, loggerWithConfigCoverageTotal)

	exitCode := m.Run()

	writeCoverageReport(loggerWithConfigCoverage, loggerWithConfigCoverageTotal, "loggerWithConfig")
